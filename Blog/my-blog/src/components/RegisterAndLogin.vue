<template>
  <el-dialog title="登录" :visible="dialogVisible" @close="cancel">
    ...
    <div class="dialog-footer" slot="footer">
      <el-button type="success" @click="handleOAuth">github授权登录</el-button>
...
export default class RegisterAndLogin extends Vue {
  ...
  private handleOAuth(): void {
    ...
    window.location.href = 'https://github.com/login/oauth/authorize?client_id=561c39808f0ff7f441d1&redirect_uri=https://localhost:8080/'
  }
